...
describe('maxAmountSpend', () => {
  ...
  it('should has value when CurrencyAmount is ETH and CurrencyAmount is higher than min bnb', () => {
    expect(
      JSBI.greaterThan(
  ...
  it('should be 0 when CurrencyAmount is ETH and CurrencyAmount is low', () => {
