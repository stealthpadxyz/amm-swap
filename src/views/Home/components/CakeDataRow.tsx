...
const emissionsPerBlock = 0.1

/**
 * User (Planet Finance) built a contract on top of our original manual STEALTH pool,
 ...
 * https://twitter.com/StealthPad/status/1523913527626702849
 * https://etherscan.io/tx/0xd5ffea4d9925d2f79249a4ce05efd4459ed179152ea5072a2df73cd4b9e88ba7
 */
  ...
  return (
    <Grid>
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'c' }}>
        <Text color="textSubtle">{t('Token Price')}</Text>

        <Balance decimals={6} lineHeight="1.1" fontSize="24px" bold value={cakePriceBusd.toNumber()} prefix="$" />
      </StyledColumn>
