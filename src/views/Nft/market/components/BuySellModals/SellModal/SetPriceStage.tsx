...
const SetPriceStage: React.FC<SetPriceStageProps> = ({
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      ...
      <Text>{t('%percentage%% trading fee will be used to buy & burn STEALTH', { percentage: tradingFee })}</Text>
    </>,
    { placement: 'auto' },
  )
    ...
    <>
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WETH. You can swap WETH to ETH 1:1 for free with StealthPad.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
