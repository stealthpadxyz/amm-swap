...
const Container = styled(Flex)`
  ...
  background: linear-gradient(0deg, rgba(39, 38, 44, 0.4), rgba(39, 38, 44, 0.4)),
    linear-gradient(180deg,  #51D6C6 0%, #22866E 100%);
...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://app.punkswap.exchange - check the URL carefully.")
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://app.punkswap.exchange'}
          color={text === 'https://app.punkswap.exchange' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
