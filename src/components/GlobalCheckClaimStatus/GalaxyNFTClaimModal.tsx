    ...
    <Modal title={t('Congratulations!')} onDismiss={onDismiss}>
      <Flex flexDirection="column" alignItems="center" justifyContent="center">
        ...
        <Text textAlign="center" bold color="secondary" maxWidth="400px" fontSize="16px" mb="16px">
          {t('Hello, early fixed-term staking pool STEALTH lovers.')}
        </Text>
        <Text textAlign="center" maxWidth="400px" mb="12px">
          {t(
            'If you staked in our fixed-term staking pool for 52 weeks within the first 24 hours of the launch, you are eligible to claim a special edition “Project Galaxy x StealthPad” NFT.',
          )}
        </Text>
        <Text textAlign="center" maxWidth="400px" mb="12px">
          {t(
        ...
        <Button
          ...
          scale="sm"
          as="a"
          href="https://twitter.com/StealthPad/status/1521825079591845888"
