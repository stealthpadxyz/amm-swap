...
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.STEALTHGOERLI]: new Token(ChainId.STEALTHGOERLI, UNI_ADDRESS, 18, 'UNI', 'Uniswap')
}
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.STEALTHGOERLI]: [WETH[ChainId.STEALTHGOERLI]]
}
