...
import { BASES_TO_TRACK_LIQUIDITY_FOR, PINNED_PAIRS, farmsConfig, farmsTestConfig } from 'config/constants'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'STEALTH-LP', 'STEALTH LPs')
}
