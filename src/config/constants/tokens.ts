...
export const bscTokens = {
  ...
  lazio: new Token(
    ...
    'LAZIO',
    'FC Lazio Fan Token',
    'https://nftstaking.binance.com/en/subscription/LAZIO_BNB',
  ),
  ...
  porto: new Token(
    ...
    'PORTO',
    'FC Porto Fan Token',
    'https://nftstaking.binance.com/en/subscription/PORTO_BNB',
  ),
  kart: new Token(
    ChainId.BSC,
  ...
  santos: new Token(
    ...
    'SANTOS',
    'FC Santos Fan Token',
    'https://nftstaking.binance.com/en/launchpool/SANTOS_BNB',
  ),
  nabox: new Token(
    ChainId.BSC,
