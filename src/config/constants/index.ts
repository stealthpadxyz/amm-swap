...
export { default as farmsTestConfig } from './testnetfarms'
...
export const EXCHANGE_DOCS_URLS = 'https://t.me/PunkSwapDEX'
// export const EXCHANGE_DOCS_URLS = 'https://docs.punkswap.exchange/products/pancakeswap-exchange'
